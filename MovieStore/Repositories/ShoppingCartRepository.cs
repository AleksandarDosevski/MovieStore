...
namespace MovieStore.Repositories
{
    public class ShoppingCartRepository : IShoppingCartRepository
    {
        ...
        {
            var shoppingCart = GetShoppingCartByMovieId(Id);
            _context.ShoppingCarts.Remove(shoppingCart);
            _context.SaveChanges();
        }
        ...
        public ShoppingCart GetShoppingCartByMovieId(int movieID)
        {
            var result = _context.ShoppingCarts.FirstOrDefault(x => x.MovieId == movieID);
            return result;
        }
    }
}
